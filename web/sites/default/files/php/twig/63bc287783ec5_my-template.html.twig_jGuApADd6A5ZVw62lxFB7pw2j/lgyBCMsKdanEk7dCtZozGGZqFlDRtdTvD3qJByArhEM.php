...
<div id=\"overlay\"></div>
  ";
      ...
      ";
        ...
        <h2> ";
            // line 17
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["value"], "name", [], "any", false, false, true, 17), 17, $this->source), "html", null, true);
            echo "</h2>
      </div>
      <div class=\"role\">
        <p> ";
            // line 20
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["value"], "known_for_department", [], "any", false, false, true, 20), 20, $this->source), "html", null, true);
            echo "</p>
      </div>
      <div class=\"card-body\">
...
";
    ...
    {
        return array (  99 => 28,  89 => 24,  82 => 20,  76 => 17,  73 => 16,  67 => 13,  64 => 12,  62 => 11,  57 => 10,  53 => 9,  43 => 2,  39 => 1,);
    }
