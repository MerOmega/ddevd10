...
/* themes/custom/movietheme/templates/field/field.html.twig */
class __TwigTemplate_0cdd1a4745bbbb82c090fa004dd3ea5e extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["label_hidden"] ?? null)) {
            ...
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "content", [], "any", false, false, true, 46), 46, $this->source), "html", null, true);
            echo "\">
  ";
            // line 47
...
";
    ...
    {
        return "themes/custom/movietheme/templates/field/field.html.twig";
    }
    ...
    {
        return array (  138 => 70,  134 => 68,  131 => 67,  120 => 65,  115 => 64,  111 => 62,  109 => 61,  103 => 60,  98 => 59,  94 => 57,  83 => 55,  78 => 54,  74 => 52,  63 => 50,  59 => 49,  54 => 48,  52 => 47,  47 => 46,  45 => 45,  42 => 44,  40 => 41,  39 => 40,);
    }
...
{% if label_hidden %}
  <div class=\"field-field {{ item.content }}\">
  {% if multiple %}
    <div{{ attributes }}>
      {% for item in items %}
        <div{{ item.attributes }}  class=\"text-item\">{{ item.content }}</div>
      {% endfor %}
    </div>
  {% else %}
    {% for item in items %}
      <div{{ attributes }}  class=\"text-item\">{{ item.content }}</div>
    {% endfor %}
  {% endif %}
{% else %}
  <div{{ attributes }}>
...
{% endif %}
", "themes/custom/movietheme/templates/field/field.html.twig", "/var/www/html/web/themes/custom/movietheme/templates/field/field.html.twig");
    }
