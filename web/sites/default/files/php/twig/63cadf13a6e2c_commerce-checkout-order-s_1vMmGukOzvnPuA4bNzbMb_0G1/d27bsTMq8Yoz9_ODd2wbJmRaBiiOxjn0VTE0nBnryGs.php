...
class __TwigTemplate_d29ccac70f8194e41cb7cc16708851f6 extends Template
{
    private $source;
    private $macros = [];
...
<div{{ attributes.addClass('checkout-order-summary') }}>
  ...
  {% block totals %}
    {{ rendered_totals }}
  {% endblock %}
</div>", "modules/contrib/commerce/modules/checkout/templates/commerce-checkout-order-summary.html.twig", "/var/www/html/web/modules/contrib/commerce/modules/checkout/templates/commerce-checkout-order-summary.html.twig");
    }
