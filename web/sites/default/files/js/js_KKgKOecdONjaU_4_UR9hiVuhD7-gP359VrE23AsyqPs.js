...
const lenguage_block = document.querySelector("#lenguage-short img");

console.log(lenguage_block)
...
function waitForEl(selector, callback) {
  ...
  waitForEl("#lenguage-short img", function(){
    document.querySelector("#lenguage-short img").addEventListener("click",(event)=>{
        console.log(event)
    })
  });

/* END OF DOM WAIT */
// lenguage_block.addEventListener("click",()=>{
//     console.log("clicked")
// })
