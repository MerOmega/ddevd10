...
// Select all elements with class of "glow-image"
var images = document.querySelectorAll(".field-image img");
// Select all elements with class of "glow-shadow"
var elements = document.querySelectorAll(".field-image img");

for (var i = 0; i < images.length; i++) {
    // Get the average color of the image
    var averageColor = getAverageColor(images[i]);
    // Set the initial box-shadow
    elements[i].style.boxShadow = "0 0 20px 5px" + averageColor;
    // Animate the box-shadow
    setInterval(function() {
      var newBlur = Math.random() * 20;
      elements[i].style.boxShadow = "0 0 " + newBlur + "px " + averageColor;
    }, 50);
}
