...
const variation = document.querySelectorAll(".Variations .Variations .form-actions.js-form-wrapper.form-wrapper");

variation.forEach((element) => {
    console.log(element)
    // let button = document.createElement("button");
    // button.className = element.className;
    // button.setAttribute("data-drupal-selector", element.getAttribute("data-drupal-selector"));
    // button.setAttribute("type", element.getAttribute("type"));
    // button.setAttribute("id", element.getAttribute("id"));
    ...
    // input.parentNode.replaceChild(button, element);
});
/**
 * @file
