...
var inputs = document.querySelectorAll('.js-form-submit');
...
for (var i = 0; i < inputs.length; i++) {
  ...
  button.setAttribute("data-drupal-selector", input.getAttribute("data-drupal-selector"));
  button.setAttribute("type", input.getAttribute("type"));
