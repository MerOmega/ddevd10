...
card.forEach(box => {
  box.addEventListener('click', ()=> {
    element = docuemnt.querySelector("grid");
    element.innerHTML=`
    <div class="container">
      <div class="popup" id="popup">
        <h1> Testing</h1>
        <p>Lorem ipsum dolor sit amet consectetur
        adipisicing elit. Inventore obcaecati ratione 
        enim fuga at asperiores ipsum laborum sequi sed 
        adipisci veritatis, voluptates tempore ab,
        culpa maiores mollitia quia atque. Doloremque?</p>
        <p>Lorem ipsum dolor sit amet consectetur
        adipisicing elit. Inventore obcaecati ratione 
        enim fuga at asperiores ipsum laborum sequi sed 
        adipisci veritatis, voluptates tempore ab,
